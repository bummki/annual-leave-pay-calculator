...
export const metadata: Metadata = {
    title: "2026 황금연휴 시뮬레이터 | 연차 최적화",
    description: "연차 1개로 긴 휴식을! 2026년 공휴일을 분석하여 가성비 최고의 휴가 일정을 추천해드립니다.",
};
    ...
    return (
        <div className="min-h-screen bg-slate-50 py-12 px-4">
            <header className="mb-12 text-center max-w-3xl mx-auto">
                <h1 className="text-3xl font-extrabold text-foreground mb-4">2026 황금연휴 시뮬레이터</h1>
